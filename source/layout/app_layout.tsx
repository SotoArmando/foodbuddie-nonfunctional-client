...
import { SkiaTutorial } from '../screens/morphtestskia';
import { PlannerAdd } from '../screens/planner_add';
import { SearchScreen } from '../screens/searchscreen';
import { RecipesDetails } from '../screens/recipedetail';
        ...
        transform: [
            {
                translateX: current.progress.interpolate({
                    inputRange: [-1, 0, 1], // Normalized progress range
                    outputRange: [0, 0, screenWidth], // Corresponding translateX values
                }),
            },
        ],
        display: (current.progress <= -1 || current.progress >= 1) ? 'none' : 'content',
