...
import { Freezed } from "../util/freezed";
...
const tLines = chunk(recipeTitleString, 22);
const dLines = chunk(recipeDescription, 42);
export const RecipesDetails = () => {
    ...
    return <ScrollView showsVerticalScrollIndicator={true} removeClippedSubviews={true}>
        <View style={RecipeDetailComponent}>
            <View style={{ ...RecipeDetailTitleRow, marginBottom: scale(13) }}>
                <View style={{ ...RecipeDetailTitleRow, justifyContent: '' }}>
                    ...
                    <PrerenderedText height={tLines.length * 36} width={270} hot={true} lines={tLines} style={RecipeDetailTitleRowLabel} isFocused={isFocused} viewStyle={{ transform: transform(-0.5, 1) }}></PrerenderedText>
                </View>
                <View style={{ ...RecipeDetailTitleRow, justifyContent: '' }}>
            ...
            <PrerenderedText
                width={361}
                height={24 * dLines.length}
                anchor="start"
                hot={true}
                lines={dLines} isFocused={isFocused} style={RecipeDetailDescription}></PrerenderedText>

            <View style={{ minHeight: scale(110), marginTop: scale(17), backgroundColor: '', position: 'relative' }}>
                <Freezed manager={true} hot={true}>
            ...
            <Freezed manager={true} hot={false}>
