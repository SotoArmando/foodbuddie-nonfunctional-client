            ...
            <View style={RecipeDetailComponent}>
                <View style={{ ...RecipeDetailTitleRow, marginBottom: scale(13) }}>
                    <View style={{ ...RecipeDetailTitleRow, justifyContent: '' }}>
                        ...
                        <PrerenderedText height={chunk(recipeTitleString, 22).length * 36} width={270} hot={true} lines={chunk(recipeTitleString, 22)} style={RecipeDetailTitleRowLabel} isFocused={isFocused} viewStyle={{ transform: transform(-0.5, 1) }}></PrerenderedText>
                    </View>
                    <View style={{ ...RecipeDetailTitleRow, justifyContent: '' }}>
